...
<head>
    ...
    MailChimp automatically inlines CSS for you or you can use this tool: http://beaker.mailchimp.com/inline-css. */
        ...
        /* Template Styles */
		h1 { color:#900; font-weight:400; font-size:64px; font-family:"Qwigley"; text-align:center;	}
		a { color:inherit; text-decoration:none; }
		a:hover { color:#900 !important; -webkit-transition-property: color; -webkit-transition-duration: 1s; -webkit-transition-timing-function: linear; }
		#utility a:hover {color:#000 !important;}
